 ...
 * @author AmirIjaz
 */
public class AdminViewMovies extends javax.swing.JFrame {

    /**
     * Creates new form AdminViewMovies
     */
    public AdminViewMovies() {
     ...
     public void dataInsert() {
        ...
        try {
            ...
            String SQL = "SELECT movies.m_name, movies.m_genre, movies.m_language, theater.t_name, theater.t_location From movies FULL OUTER JOIN theater ON movies.theater_t_id=theater.t_id";
            ...
            while (result.next()) {
                ...
                Object[] row = {m_name, m_genre, m_language, t_name, t_location};
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Name", "Genre", "Language", "Theater Name", "Location"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminViewMovies.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
