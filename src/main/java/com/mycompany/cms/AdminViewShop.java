 ...
 * @author AmirIjaz
 */
public class AdminViewShop extends javax.swing.JFrame {

    /**
     * Creates new form AdminViewShop
     */
    ...
    public void dataInsert() {
        ...
        try {
            ...
            while (result.next()) {
                ...
                location = result.getString("S_Location");
                openTime = result.getString("S_OPEN_TIME");
                closeTime = result.getString("S_CLOSE_TIME");
                Object[] row = {name, location, openTime, closeTime};
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Name", "Location", "Opening Time", "Closing Time"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminViewShop.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
