...
public class EditMovie extends javax.swing.JFrame {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(genre, javax.swing.GroupLayout.DEFAULT_SIZE, 136, Short.MAX_VALUE)
                    .addComponent(language, javax.swing.GroupLayout.DEFAULT_SIZE, 136, Short.MAX_VALUE))
    ...
    private void choiceItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_choiceItemStateChanged
        ...
        try {
            con = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:XE", "fatima1", "12345");
            java.sql.Statement st = con.createStatement();
            String SQL = "SELECT * from movies where m_name = '" + value + "'";
            ResultSet result = st.executeQuery(SQL);
            while (result.next()) {
                dataId = result.getString("M_ID");
                getName = result.getString("M_NAME");
                getGenre = result.getString("M_GENRE");
                getLanguage = result.getString("M_LANGUAGE");
    ...
    private void saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveActionPerformed
        // TODO add your handling code here:
        String get_genre=genre.getText();
        String get_name=name.getText();
        String get_language=language.getText();

        Connection con;
        try {
            con = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:XE", "fatima1", "12345");
            java.sql.Statement st = con.createStatement();
            String SQL = "UPDATE movies SET m_genre='"+get_genre+"', m_name='"+get_name+"', m_language='"+get_language+"' WHERE m_id='"+dataId+"'";
            ResultSet result = st.executeQuery(SQL);
