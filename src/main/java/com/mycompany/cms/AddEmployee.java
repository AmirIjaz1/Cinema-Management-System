    ...
    private void addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addActionPerformed
        ...
        if (getName != "" && getEmail != "" && getPassword != "" && getPhone != "") {
            try {
                ...
                String SQL = "INSERT INTO employee (e_id, e_name, e_email_id, e_phone_no, e_password) Values ('" + randomInt + "','" + getName + "','" + getEmail + "','" + getPhone + "','" + getPassword + "')";
            ...
            error.setText("Please Fill Correct Values");
        }
