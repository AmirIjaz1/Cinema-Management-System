 ...
 * @author AmirIjaz
 */
public class DeleteTheater extends javax.swing.JFrame {

    /**
     * Creates new form DeleteTheater
     */
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        ...
        try {
            ...
            con = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:XE", "fatima1", "12345");
            java.sql.Statement st = con.createStatement();
            String SQL = "DELETE FROM theater WHERE t_name='" + select + "'";
            ResultSet result = st.executeQuery(SQL);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeleteTheater.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
